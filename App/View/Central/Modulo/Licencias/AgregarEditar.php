                ...
                <div class="container">
                    ...
                    <div class="row mx-1">
                        <div class="col-3">
                            <label for="campo" class="text-input-rem form-label input-text-form">Fecha
                                inicio</label>
                            <input type="date" id="fecha_desde_licen" class="form-control custom-input">
                            <div class="line"></div>
                        </div>
                        <div class="col-3">
                            <label for="campo" class="text-input-rem form-label input-text-form">Fecha fin</label><label
                                class="text-required">*</label>
                            <input type="date" id="fecha_hasta_licen" placeholder="Motivo" class="form-control custom-input">
                            <div class="line"></div>
                        </div>
                        <div class="col-3">
                    ...
                    <div class="row mx-1">
                        <div class="col-3">
                            ...
                            <input type="date" id="fecha_registro_licen" placeholder="Motivo"
                                class="form-control custom-input">
                            <div class="line"></div>
                        </div>
                        <div class="col-9">
