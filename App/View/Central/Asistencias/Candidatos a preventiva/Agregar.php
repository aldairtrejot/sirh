        ...
        <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h1 class="text-tittle-card"><label id="" claa="text-modal-tittle"></label>
                                Agregar Inasistemcias >3.
                            </h1>
                            <p class="color-text-white">Este espacio está destinado a agregar, modificar o eliminar
                                faltas de empleados mayores a 3. Es fundamental seguir las siguientes instrucciones para hacerlo de
                                manera correcta</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <div class="alert alert-warning" role="alert">
                    <p><strong>Cómo agregar o modificar una falta mayor a 3 dias:</strong></p>
                    <ol>
            ...
            <div class="modal-footer">
                <button onclick="ocultar();" type="button" class="btn btn-secondary" data-dismiss="modal"><i
